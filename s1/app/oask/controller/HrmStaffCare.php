...
class HrmStaffCare extends OaskBase
{
	...
	{
		$orderby = $this->logicHrmStaffCare->getOrderby($this->param);
		$where = $this->logicHrmStaffCare->getWhere($this->param);
		$list = $this->logicHrmStaffCare->getHrmStaffCareList($where,'a.*,s.name as staff_name',$orderby);
		return $list;
	}
	...
	public function add()
	{
		...
		IS_POST && $this->jump($this->logicHrmStaffCare->hrmStaffCareAdd($this->param));
		$this->common_data();
	...
	public function edit()
	{
		...
		IS_POST && $this->jump($this->logicHrmStaffCare->hrmStaffCareEdit($this->param));
		$info = $this->logicHrmStaffCare->getHrmStaffCareInfo(['id' => $this->param['id']]);
	...
	public function del()
	{
		...
		$this->jump($this->logicHrmStaffCare->hrmStaffCareDel($where));
	}
