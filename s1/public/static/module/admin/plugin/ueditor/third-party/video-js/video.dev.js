...
vjs.Menu.prototype.createEl = function(){
  ...
  // Prevent clicks from bubbling up. Needed for SysMenu Buttons,
...
/**
 * SysMenu button with a popup for showing the volume slider.
 * @constructor
 */
...
//   var menu = new vjs.SysMenu(this.player_);
...
vjs.CaptionsButton = vjs.TextTrackButton.extend({
  ...
  init: function(player, options, ready){
    ...
    this.el_.setAttribute('aria-label','Captions SysMenu');
  }
});
...
vjs.SubtitlesButton = vjs.TextTrackButton.extend({
  ...
  init: function(player, options, ready){
    vjs.TextTrackButton.call(this, player, options, ready);
    this.el_.setAttribute('aria-label','Subtitles SysMenu');
  }
});
...
vjs.ChaptersButton = vjs.TextTrackButton.extend({
  ...
  init: function(player, options, ready){
    vjs.TextTrackButton.call(this, player, options, ready);
    this.el_.setAttribute('aria-label','Chapters SysMenu');
  }
});
