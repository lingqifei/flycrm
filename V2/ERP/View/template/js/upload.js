function DragImgUpload(id,options) {
    ...
    this.preview = $('<div id="preview"><img src="/upload/images/upload.png" class="img-responsive"  style="width: 100%;height: auto;" alt="" title=""> </div>');
...
DragImgUpload.prototype = {
    init:function () {
		a=this.me.find('img').length;
		if(a==0)  this.me.append(this.preview);
