<?php /* Smarty version 2.6.26, created on 2017-05-22 08:57:50
         compiled from email/email_from_group.html */ ?>
<div class="pageHeader">
  <form onsubmit="return navTabSearch(this);"
	action="<?php echo @ACT; ?>
/EmailSend/email_from_group_show" method="post">
    <div class="searchBar">
...
<div class="pageContent">
  <div class="panelBar">
    <ul class="toolBar">
      <li><a class="add"
		href="<?php echo @ACT; ?>
/EmailSend/email_from_group_add/" target="dialog"
		rel="email_from_group_add" title="分组添加"><span>添加</span></a></li>
      <li> <a class="delete" href="<?php echo @ACT; ?>
/EmailSend/email_from_group_del/" postType="string" title="确定要删除吗?"  target="selectedTodo" rel="ids"><span>删除选择</span></a></li>
      <li><a class="edit"
		href="<?php echo @ACT; ?>
/EmailSend/email_from_group_modify/id/{sid_user}/"
		target="dialog" rel="email_from_group_modify" title="分组修改"><span>修改</span></a></li>
...
" type="checkbox"></td>
    ...
    <div class="panelBar">
      <form id="pagerForm" method="post"
		action="<?php echo @ACT; ?>
/EmailSend/email_from_group_show/">
        <input
