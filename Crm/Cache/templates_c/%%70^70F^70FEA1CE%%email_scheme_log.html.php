<?php /* Smarty version 2.6.26, created on 2016-06-13 16:10:08
         compiled from email/email_scheme_log.html */ ?>
...
/EmailSend/email_scheme_log_del/" postType="string" title="确定要删除吗?"  target="selectedTodo" rel="ids"><span>删除选择</span></a></li>
    ...
    <table class="table" width="100%" layoutH="138">
      <thead>
        <tr>
          ...
          <th align="left" width="200">发送地址</th>
          <th align="left" width="200">接收地址</th>
          <th align="left" width="">发送主题</th>
          <th align="left" width="150">发送时间</th>
        </tr>
      </thead>
      <tbody>
...
" type="checkbox"></td>
        ...
        <td align="left"><?php echo $this->_tpl_vars['v']['status']; ?>
</td>
        <td align="left"><?php echo $this->_tpl_vars['v']['sendfrom']; ?>
</td>
        <td align="left"><?php echo $this->_tpl_vars['v']['receiver']; ?>
</td>
        <td align="left"><?php echo $this->_tpl_vars['v']['subject']; ?>
</td>
        <td align="left"><?php echo $this->_tpl_vars['v']['adddatetime']; ?>
</td>
      </tr>
    ...
    <div class="panelBar">
      <form id="pagerForm" method="post"
		action="<?php echo @ACT; ?>
/EmailSend/email_scheme_log_show/">
        <input
