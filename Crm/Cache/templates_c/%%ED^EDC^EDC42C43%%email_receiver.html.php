<?php /* Smarty version 2.6.26, created on 2016-06-13 16:09:53
         compiled from email/email_receiver.html */ ?>
<div class="pageHeader">
  <form onsubmit="return navTabSearch(this);"
	action="<?php echo @ACT; ?>
/EmailSend/email_receiver_show" method="post">
    <div class="searchBar">
...
/EmailSend/email_receiver_group_show/"  target="navTab" rel="email_receiver_group"><span>接收地址分组管理</span></a></td>
        </tr>
      </table>
    </div>
  </form>
...
<div class="pageContent">
  <div class="panelBar">
    <ul class="toolBar">
      <li><a class="add"
		href="<?php echo @ACT; ?>
/EmailSend/email_receiver_add/" target="dialog"
		rel="email_receiver_add" title="接收地址添加"><span>添加</span></a></li>
      <li> <a class="delete" href="<?php echo @ACT; ?>
/EmailSend/email_receiver_del/" postType="string" title="确定要删除吗?"  target="selectedTodo" rel="ids"><span>删除选择</span></a></li>
      <li><a class="edit"
		href="<?php echo @ACT; ?>
/EmailSend/email_receiver_modify/id/{sid_user}/"
		target="dialog" rel="email_receiver_modify" title="接收地址修改"><span>修改</span></a></li>
      <li><a class="add"
		href="<?php echo @ACT; ?>
/EmailSend/email_receiver_add_more/" target="navTab"
