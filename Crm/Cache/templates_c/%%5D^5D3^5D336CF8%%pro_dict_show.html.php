<?php /* Smarty version 2.6.26, created on 2016-06-30 15:00:28
         compiled from pro_dict/pro_dict_show.html */ ?>

<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="<?php echo @ACT; ?>
/ProDict/pro_dict_show" method="post">
	<div class="searchBar">
...
/ProDict/search/" target="dialog" mask="true" title="查询框"><span>高级检索</span></a></li>
			</ul>
		</div>
	</div>
	</form>
...
/ProDict/pro_dict_add/type/<?php echo $this->_tpl_vars['type']; ?>
/" target="dialog"><span>添加</span></a></li>
			<li><a class="delete" href="<?php echo @ACT; ?>
/ProDict/pro_dict_del/type/<?php echo $this->_tpl_vars['type']; ?>
/id/{sid_user}/" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			<li><a class="edit" href="<?php echo @ACT; ?>
/ProDict/pro_dict_modify/type/<?php echo $this->_tpl_vars['type']; ?>
...
/ProDict/pro_dict_show/type/<?php echo $this->_tpl_vars['type']; ?>
">
