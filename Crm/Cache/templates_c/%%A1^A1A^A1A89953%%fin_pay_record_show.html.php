<?php /* Smarty version 2.6.26, created on 2017-05-22 21:44:47
         compiled from fin_pay_record/fin_pay_record_show.html */ ?>
<div class="pageHeader">
  <form onsubmit="return navTabSearch(this);"
	action="<?php echo @ACT; ?>
/FinPayRecord/fin_pay_record_show/" method="post">
    <div class="searchBar">
...
<div class="pageContent">
  <div class="panelBar">
    <ul class="toolBar">
      <li><a class="add"
		href="<?php echo @ACT; ?>
/FinPayRecord/fin_pay_record_add/" target="dialog"
		rel="fin_pay_record_add" title="付款记录添加" width='850' height='450'><span>添加</span></a></li>
      <li> <a class="delete" href="<?php echo @ACT; ?>
/FinPayRecord/fin_pay_record_del/" postType="string" title="确定要删除吗?"  target="selectedTodo" rel="ids"><span>删除</span></a></li>
    </ul>
  </div>
  <ul>
