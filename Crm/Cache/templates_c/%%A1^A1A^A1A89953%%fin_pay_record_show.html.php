<?php /* Smarty version 2.6.26, created on 2016-06-30 15:06:05
...
<div class="pageContent">
  <div class="panelBar">
    <ul class="toolBar">
      <li><a class="add"
		href="<?php echo @ACT; ?>
/FinPayRecord/fin_pay_record_add/" target="navTab"
		rel="fin_pay_record_add" title="付款计划添加"><span>添加</span></a></li>
      <li> <a class="delete" href="<?php echo @ACT; ?>
/FinPayRecord/fin_pay_record_del/" postType="string" title="确定要删除吗?"  target="selectedTodo" rel="ids"><span>删除选择</span></a></li>
    </ul>
  </div>
  <ul>
