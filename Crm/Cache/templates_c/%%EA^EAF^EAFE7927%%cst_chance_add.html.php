<?php /* Smarty version 2.6.26, created on 2017-02-09 15:48:47
...
/CstDict/cst_dict_select/type/salestage/" lookupGroup="salestage"/>
			...
			<p>
				<label>发现时间：</label>
				<input type="text" name="finddt" class="date" dateFmt="yyyy-MM-dd HH:mm:ss" readonly="true"/>
				<a class="inputDateButton" href="javascript:;">选择</a>
			</p>
			<p>
				<label>预计签单时间：</label>
				<input type="text" name="billdt" class="date" dateFmt="yyyy-MM-dd HH:mm:ss" readonly="true"/>
				<a class="inputDateButton" href="javascript:;">选择</a>
			</p>
			<p>
				<label>预计金额：</label>
