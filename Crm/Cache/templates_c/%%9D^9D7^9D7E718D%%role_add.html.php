<?php /* Smarty version 2.6.26, created on 2016-11-21 17:56:01
         compiled from role/role_add.html */ ?>
<div class="pageContent">
  <form method="post" action="<?php echo @ACT; ?>
/Role/role_add/" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
    <div class="pageFormContent" layoutH="56">
      <p>
        <label>权限名称：</label>
        <input name="name" class="required" type="text" size="30" value="" alt="请输权限名称"/>
      </p>
      <p>
        <label>排位序号：</label>
