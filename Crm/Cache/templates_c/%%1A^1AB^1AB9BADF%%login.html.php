<?php /* Smarty version 2.6.26, created on 2017-07-17 17:33:24
...
/View/ui/login/images/people.png' id='admin'/>
    ...
    <div class="login-btn-set"><div class='rem'>记住我</div> <input id="login" type="submit" class='login-btn' value=""></div>
