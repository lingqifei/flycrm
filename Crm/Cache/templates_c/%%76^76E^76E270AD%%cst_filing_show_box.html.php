<?php /* Smarty version 2.6.26, created on 2017-02-09 12:10:10
         compiled from cst_filing/cst_filing_show_box.html */ ?>
<div class="pageHeader">
  <form id="pagerForm" onsubmit="return divSearch(this, 'jbsxBox_cus');" action="<?php echo @ACT; ?>
/CstFiling/cst_filing_show_box/" method="post">
...
/CstFiling/cst_filing_add/" target="dialog" rel="cst_filing_add" title="项目报备添加"><span>添加</span></a></li>
...
/CstFiling/cst_filing_modify/id/{sid_user}/" target="dialog" rel="cst_filing_modify" title="项目报备修改"><span>修改</span></a></li>
      <li class="line">line</li>
    </ul>
  </div>
