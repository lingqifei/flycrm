<?php /* Smarty version 2.6.26, created on 2016-06-13 16:09:56
         compiled from email/email_mb.html */ ?>
<div class="pageHeader">
  <form onsubmit="return navTabSearch(this);"
	action="<?php echo @ACT; ?>
/EmailSend/email_mb_show" method="post">
    <div class="searchBar">
...
<div class="pageContent">
  <div class="panelBar">
    <ul class="toolBar">
      <li><a class="add"
		href="<?php echo @ACT; ?>
/EmailSend/email_mb_add/" target="navTab"
		rel="email_mb_add" title="模板添加"><span>添加</span></a></li>
      <li> <a class="delete" href="<?php echo @ACT; ?>
/EmailSend/email_mb_del/" postType="string" title="确定要删除吗?"  target="selectedTodo" rel="ids"><span>删除选择</span></a></li>
      <li><a class="edit"
		href="<?php echo @ACT; ?>
/EmailSend/email_mb_modify/id/{sid_user}/"
		target="navTab" rel="email_mb_modify" title="模板修改"><span>修改</span></a></li>
...
" type="checkbox"></td>
        ...
        <td align="left"><?php echo $this->_tpl_vars['v']['1']; ?>
</td>
