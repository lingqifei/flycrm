<?php /* Smarty version 2.6.26, created on 2017-02-08 16:16:40
         compiled from fin_rece_record/fin_rece_record_show_box.html */ ?>
<div class="pageHeader">
  <form id="pagerForm" onsubmit="return divSearch(this,'jbsxBox');"
	action="<?php echo @ACT; ?>
/FinReceRecord/fin_rece_record_show_box/" method="post">
...
<div class="pageContent">
  <div class="panelBar">
    <ul class="toolBar">
      ...
      <li> <a class="pro" href="javascript:;"><span>回款总金额: <font color="red"><?php echo $this->_tpl_vars['total_money']; ?>
</font></span></a> </li>
      <li class="line">line</li>
    </ul>
  </div>
