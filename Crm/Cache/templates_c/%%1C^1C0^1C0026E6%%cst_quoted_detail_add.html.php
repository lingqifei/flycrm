<?php /* Smarty version 2.6.26, created on 2016-12-22 11:22:50
         compiled from cst_quoted_detail/cst_quoted_detail_add.html */ ?>
<form  action="<?php echo @ACT; ?>
/CstQuotedDetail/cst_quoted_detail_add/id/<?php echo $this->_tpl_vars['one']['id']; ?>
/" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone)">
<div class="pageContent">
	<div class="pageFormContent" layoutH="97">
			<fieldset>
			<legend>产品报价信息：</legend>
			<p>
				<label>客户名称：</label>
...
/CstChance/cst_chance_select/cusID/{cusID}/" warn="请选择客户名称" lookupGroup="chance" readonly="readonly"/>
			...
			<p>
				<label>审核时间：</label>
					<input name="title" class="required" type="text" value="<?php echo $this->_tpl_vars['one']['audit_dt']; ?>
" readonly="readonly"/>
			</p>
			<p>
				<label>建档时间：</label>
		...
		<div class="tabs">
			<div class="tabsHeader">
				<div class="tabsHeaderContent">
					<ul>
						<li class="selected"><a href="javascript:void(0)"><span>报价明细</span></a></li>
					</ul>
				</div>
			</div>
