...
-- 正在导出表  07fly_oa.cst_dict_type 的数据：~8 rows (大约)
...
-- 正在导出表  07fly_oa.email_from 的数据：~47 rows (大约)
...
-- 正在导出表  07fly_oa.email_from_group 的数据：~1 rows (大约)
...
-- 正在导出表  07fly_oa.email_mb 的数据：~7 rows (大约)
...
-- 正在导出表  07fly_oa.email_receiver 的数据：~3 rows (大约)
...
-- 正在导出表  07fly_oa.email_receiver_group 的数据：~1 rows (大约)
...
-- 正在导出表  07fly_oa.email_scheme 的数据：~2 rows (大约)
...
-- 正在导出表  07fly_oa.fin_bank_account 的数据：~2 rows (大约)
...
-- 正在导出表  07fly_oa.fin_expenses_type 的数据：~3 rows (大约)
...
-- 正在导出表  07fly_oa.fin_income_type 的数据：~2 rows (大约)
...
-- 正在导出表  07fly_oa.fin_invoice_pay 的数据：~0 rows (大约)
...
-- 正在导出表  07fly_oa.fin_pay_plan 的数据：~0 rows (大约)
...
-- 正在导出表  07fly_oa.fin_pay_record 的数据：~0 rows (大约)
...
INSERT INTO `fly_sys_config` (`id`, `name`, `value`) VALUES
	...
	(30, 'i_ser', '<div class="divider"></div>\r\n<h2>有偿服务请联系:</h2>\r\n<pre style="margin:5px;line-height:1.6em;">\r\n定制化开发，公司培训，技术支持\r\n开发团队：零起飞\r\n技术交流：<a href="http://bbs.07fly.net/" target="_blank">论坛交流</a>\r\n技术支持：goodkfrs@qq.com\r\n</pre>'),
	(33, 'login_spath', '/images/20170109202452375.png'),
	(34, 'manager_spath', '/images/20160719111804731.png');
...
-- 正在导出表  07fly_oa.fly_sys_log 的数据：~0 rows (大约)
...
-- 正在导出表  07fly_oa.fly_sys_region 的数据：3,408 rows
...
-- 正在导出表  07fly_oa.pro_dict 的数据：~5 rows (大约)
...
-- 正在导出表  07fly_oa.pro_dict_type 的数据：~3 rows (大约)
...
-- 正在导出表  07fly_oa.pro_product 的数据：~2 rows (大约)
...
INSERT INTO `pro_product` (`id`, `name`, `pro_number`, `typeID`, `price`, `model`, `norm`, `supID`, `image`, `intro`, `sort`, `visible`, `adt`) VALUES
	(175, '200M', '20880345', 15, 200, 'M', 'M', 12, 'image', '200M空间', 0, 1, '2013-09-06 14:34:33'),
	(176, '100M', 'X807651', 14, 100, 'N8000', '个', 12, '100', '100M空间', 0, 1, '2013-09-22 09:55:02');
...
-- 正在导出表  07fly_oa.pro_type 的数据：~6 rows (大约)
...
-- 正在导出表  07fly_oa.sup_supplier 的数据：~3 rows (大约)
