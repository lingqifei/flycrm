...
- 账号：demo
- 密码：123456
- 说明：07FLY-ERP是一款开放式的管理平台，能容纳管理各种数据、实现信息互通共享；能快速搭建适合自己的是一款开放式的管理平台，能容纳管理各种数据、实现信息互通共享；具有完善应用插件扩展功能，在线安装卸载升级应用插件，第三方应用模块支持(CMS（会员中心）、办工OA、客户CRM、进销ERP、财务管理FMS、项目管理PMS等应用系统
