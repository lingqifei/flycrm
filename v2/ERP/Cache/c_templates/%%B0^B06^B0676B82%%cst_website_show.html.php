<?php /* Smarty version 2.6.26, created on 2019-09-29 18:11:52
         compiled from crm/cst_website_show.html */ ?>
<!DOCTYPE html>
<html>
...
/crm/CstWebsite/cst_website_json/';
...
/crm/CstWebsite/cst_website_add/' //iframe的url
		});			
		return false;	
	});
...
/crm/CstWebsite/cst_website_close/";
		}else if(batch_act=="open"){
			act_url="<?php echo @ACT; ?>
/crm/CstWebsite/cst_website_open/";
		}else if(batch_act=="del"){
			act_url="<?php echo @ACT; ?>
/crm/CstWebsite/cst_website_del/";
		}
	...
	$("body").on("click", ".single_operation", function() {
		...
		if(single_act=="add"){
			layer.open({
				...
				area: ['90%', '90%'],
				content: '<?php echo @ACT; ?>
/crm/CstWebsite/cst_website_add/',
				end: function () {
					turnPage(1);//页面加载时初始化分页
				}
			});			
			...
			layer.open({
				...
				area: ['90%', '90%'],
				content: '<?php echo @ACT; ?>
/crm/CstWebsite/cst_website_modify/website_id/'+website_id+'/',
				end: function () {
					turnPage(1);//页面加载时初始化分页
				}
			});			
			...
			layer.open({
				...
				area: ['90%', '90%'],
				content: '<?php echo @ACT; ?>
/crm/CstWebsite/cst_website_add_renew/website_id/'+website_id+'/',
				end: function () {
					turnPage(1);//页面加载时初始化分页
				}
			});			
