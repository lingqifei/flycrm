<?php /* Smarty version 2.6.26, created on 2019-09-29 18:05:14
         compiled from erp/fin_pay_record_show.html */ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="col-sm-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5><i class="fa fa-home"></i> 付款列表</h5>
          ...
          <div class="row">
            <form id="pagerForm" method="post" class="form-inline">
              ...
              <div class="col-sm-9 m-b-xs text-right">
                  ...
                  <select data-placeholder="付款日期所有..." name="pay_date" class="chosen-select" style="width: 150px;" >
                    <option value="0">付款日期所有</option>
            ...
            <thead>
              <tr>
                ...
                <th width="150" orderField="by_supplier" class="sort-filed"><span>供应商名称</span></th>
				  		...
				  		<th width="80"><span>付款时间</span></th>
                <th width="60"><span>期次</span></th>
                <th width="80"><span>金额</span></th>
                <th width="80"><span>去零</span></th>
...
/erp/FinPayRecord/fin_pay_record_json/';
...
/erp/FinPayRecord/fin_pay_record_del/";
...
/erp/FinPayRecord/fin_pay_record_add/',
				end: function(){
					turnPage(1);
				}
			});			
