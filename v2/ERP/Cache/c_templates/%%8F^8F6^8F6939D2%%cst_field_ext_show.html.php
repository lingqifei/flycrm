<?php /* Smarty version 2.6.26, created on 2019-10-21 14:04:37
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="ibox float-e-margins">
        ...
        <div class="row">
          <div class="col-sm-2">
			  <div class="ibox-content"><h3>表单管理</h3></div>
...
/crm/CstFieldExt/cst_field_ext_json/';
...
/crm/CstFieldExt/cst_field_ext_del/";
		}
...
/crm/CstFieldExt/cst_field_ext_modify/field_ext_id/'+field_ext_id+'/',
	...
	$("body").on("click", ".onoffswitch-checkbox", function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo @ACT; ?>
/crm/CstFieldExt/cst_field_ext_modify_visible/",
	...
	$("body").on("blur", ".modify_sort", function() {
		...
		$.ajax({
			type: "POST",
			url: "<?php echo @ACT; ?>
/crm/CstFieldExt/cst_field_ext_modify_sort/",
