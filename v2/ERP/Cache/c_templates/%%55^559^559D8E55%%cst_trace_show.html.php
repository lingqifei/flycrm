<?php /* Smarty version 2.6.26, created on 2019-11-18 18:12:50
            ...
            <thead>
              <tr>
                ...
                <th width="200" orderField="by_customer" class="sort-filed"><span>客户名称</span></th>
				  		<th width="150" orderField="by_conntime" class="sort-filed"><span>最近联系时间</span></th>
				  		<th><span>沟通内容</span></th>
                <th width="150" orderField="by_nexttime" class="sort-filed"><span>下次联系时间</span></th>
...
/crm/CstTrace/cst_trace_add/' //iframe的url
		});			
		return false;	
	});
...
/crm/CstTrace/cst_trace_modify_recommend/";
		}else if(batch_act=="del"){
			act_url="<?php echo @ACT; ?>
/crm/CstTrace/cst_trace_del/";
		}
...
/crm/CstTrace/cst_trace_add/',
			...
			layer.open({
				...
				area: ['90%', '90%'],
				content: '<?php echo @ACT; ?>
/crm/CstTrace/cst_trace_modify/trace_id/'+trace_id+'/',
				end: function () {
					turnPage(1);//页面加载时初始化分页
				}
			});			
