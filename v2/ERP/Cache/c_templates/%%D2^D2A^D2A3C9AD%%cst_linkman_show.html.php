<?php /* Smarty version 2.6.26, created on 2019-09-30 08:56:01
         compiled from crm/cst_linkman_show.html */ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="col-sm-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          ...
          <div class="ibox-tools"><a href="javascript:void(0);" class="btn btn-xs btn-default btn-help-detail" data-type="cst_linkman"> <i class="fa fa-question-circle"> 操作说明</i></a> </div>
        </div>
        <div class="ibox-content table-responsive">
          <div class="row">
            <form id="pagerForm" method="post" class="form-inline">
              <div class="col-sm-3 m-b-xs"> <a href="?" class="btn  btn-default"> <i class="fa fa-refresh">刷新</i></a> <a class="btn btn-info single_operation" data-act="add" href="javascript:void(0)"><i class="fa fa-plus"></i>添加</a>
                <div class="btn-group">
                  <button data-toggle="dropdown" class="btn btn-default dropdown-toggle">批量操作 <span class="caret"></span></button>
                  <ul class="dropdown-menu">
                    <li><a href="javascript:void(0)" class="batch_operation" data-act="send_smm">批量发短信</a></li>
                    <li><a href="javascript:void(0)" class="batch_operation" data-act="send_email">批量发邮件</a></li>
                    <li class="divider"></li>
...
/crm/CstLinkman/cst_linkman_json/';
...
/crm/CstLinkmanExport/cst_linkman_export_show/',
				end: function () {
					turnPage(1);//页面加载时初始化分页
				}
			});			
...
/crm/CstLinkman/cst_linkman_del/";
			layer.confirm('确定删除吗？', {
			  btn: ['确定','取消'] //按钮
			}, function(){
				$.ajax({
	...
	$("body").on("click", ".single_operation", function() {
		...
		if(single_act=="modify"){
			layer.open({
				...
				area: ['90%', '90%'],
				content: '<?php echo @ACT; ?>
/crm/CstLinkman/cst_linkman_modify/linkman_id/'+linkman_id+'/',
				end: function () {
					turnPage(1);//页面加载时初始化分页
				}
			});			
