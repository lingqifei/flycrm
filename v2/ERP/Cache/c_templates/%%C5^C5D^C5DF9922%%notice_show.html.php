<?php /* Smarty version 2.6.26, created on 2019-11-18 18:15:28
         compiled from sysmanage/notice_show.html */ ?>
<!DOCTYPE html>
<html>
...
/sysmanage/Notice/notice_show_json/';
...
/sysmanage/Notice/notice_add/',
			...
			layer.open({
				...
				area: ['90%', '90%'],
				content: '<?php echo @ACT; ?>
/sysmanage/Notice/notice_view/notice_id/'+notice_id+'/',
				end: function () {
					turnPage(1);
				}
			});			
