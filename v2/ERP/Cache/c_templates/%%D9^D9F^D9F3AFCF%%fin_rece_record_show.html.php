<?php /* Smarty version 2.6.26, created on 2019-10-29 16:51:20
         compiled from erp/fin_rece_record_show.html */ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="col-sm-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5><i class="fa fa-home"></i> 回款列表</h5>
          ...
          <div class="row">
            <form id="pagerForm" method="post" class="form-inline">
              ...
              <div class="col-sm-9 m-b-xs text-right">
                  ...
                  <select data-placeholder="回款日期所有..." name="back_date" class="chosen-select" style="width: 150px;" >
                    <option value="0">回款日期所有</option>
...
/erp/FinReceRecord/fin_rece_record_json/';
...
/erp/FinReceRecord/fin_rece_record_del/";
