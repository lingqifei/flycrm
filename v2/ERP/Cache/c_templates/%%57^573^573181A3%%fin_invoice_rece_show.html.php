<?php /* Smarty version 2.6.26, created on 2019-09-29 18:21:42
         compiled from erp/fin_invoice_rece_show.html */ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="col-sm-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5><i class="fa fa-home"></i> 收发票列表</h5>
          ...
          <table class="table table-hover sorttable 07fly-table" width="100%">
            <thead>
              <tr>
                ...
                <th width="200" orderField="by_supplier" class="sort-filed"><span>供应商</span></th>
				  		<th width="150"><span>合同单号</span></th>
                <th width="200"><span>发票金额/编号</span></th>
				  		<th width="100" orderField="by_recedate" class="sort-filed"><span>收票时间</span></th>
...
<% for(var i=0;i<list.length;i++) { %>
	<tr>
		...
		<td><%=list[i]['supplier']['name']%><p><small>创建于：<%=list[i]['create_time']%></small></p></td>
...
/erp/FinInvoiceRece/fin_invoice_rece_json/';
...
/erp/FinInvoiceRece/fin_invoice_rece_del/";
...
/erp/FinInvoiceRece/fin_invoice_rece_add/',
				end: function () {
					turnPage(1);//页面加载时初始化分页
				}
			});			
