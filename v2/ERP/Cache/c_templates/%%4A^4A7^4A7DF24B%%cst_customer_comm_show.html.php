<?php /* Smarty version 2.6.26, created on 2019-09-30 08:55:57
         compiled from crm/cst_customer_comm_show.html */ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="col-sm-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5><i class="fa fa-home"></i>公共客户</h5>
          ...
          <div class="row">
            <form id="pagerForm" method="post" class="form-inline">
              <div class="col-sm-3 m-b-xs"> 
				  		...
				  		<!--<a href="javascript:void(0)" class="btn btn-info single_operation" data-act="add"><i class="fa fa-plus"></i> 添加</a>-->
				  		<a href="javascript:void(0)" class="btn btn-success batch_operation" data-act="receive"><i class="fa fa-retweet"></i> 批量领取</a>
              </div>
		...
		<td width='10'>
			<div class="btn-group">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="javascript:void(0)" class="single_operation" data-id="<%=list[i]['customer_id']%>" data-act="receive">领取</a></li>
				</ul>
			</div>
		</td>
	</tr>
...
/crm/CstCustomerComm/cst_customer_comm_json/';
...
/crm/CstCustomer/cst_customer_del/";
			...
			return false;
		}else if(batch_act=="receive"){
			act_url="<?php echo @ACT; ?>
/crm/CstCustomerComm/cst_customer_comm_receive/";
			$.ajax({
				type: "POST",
				url: act_url,
				data:{"customer_id":customer_id_txt},
