<?php /* Smarty version 2.6.26, created on 2019-09-29 18:05:09
         compiled from erp/fin_pay_plan_show.html */ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="col-sm-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5><i class="fa fa-home"></i> 付款计划列表</h5>
            ...
            <form id="pagerForm" method="post" class="form-inline">
              ...
              <div class="col-sm-9 m-b-xs text-right">
                ...
                <div class="form-group text-left  pd-b-5">
                  <select data-placeholder="计划付款日期所有..." name="plan_date" class="chosen-select" style="width: 150px;" >
                    <option value="0">计划付款日期所有</option>
          ...
          <table class="table table-hover sorttable 07fly-table" width="100%">
            <thead>
              <tr>
                ...
                <th orderField="by_supplier" class="sort-filed"><span>供应商名称</span></th>
                <th width="150"><span>采购合同</span></th>
...
/erp/FinPayPlan/fin_pay_plan_json/';
...
/erp/FinPayPlan/fin_pay_plan_del/";
		}
...
/erp/FinPayPlan/fin_pay_plan_sure/plan_id/'+plan_id+'/',
				end: function () {
					turnPage(1);//页面加载时初始化分页
				}
			});			
...
/erp/FinPayPlan/fin_pay_plan_add/',
			...
			layer.open({
				...
				area: ['90%', '90%'],
				content: '<?php echo @ACT; ?>
/erp/FinPayPlan/fin_pay_plan_modify/plan_id/'+plan_id+'/',
				end: function () {
					turnPage(1);//页面加载时初始化分页
				}
