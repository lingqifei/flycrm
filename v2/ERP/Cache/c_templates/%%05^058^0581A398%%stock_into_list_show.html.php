<?php /* Smarty version 2.6.26, created on 2019-11-20 11:14:10
         compiled from erp/stock_into_list_show.html */ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="col-sm-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5><i class="fa fa-home"></i> 入库明细列表</h5>
          ...
          <table class="table table-hover sorttable 07fly-table" width="100%">
            <thead>
              <tr>
                ...
                <th width="150"><span>对应入库单</span></th>
                <th width="100"><span>入库时间</span></th>
...
/erp/StockIntoList/stock_into_list_json/';
