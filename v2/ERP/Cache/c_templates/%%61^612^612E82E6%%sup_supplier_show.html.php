<?php /* Smarty version 2.6.26, created on 2019-09-29 18:12:49
...
/erp/SupSupplier/sup_supplier_json/';
...
/erp/SupSupplier/sup_supplier_modify_recommend/";
		}else if(batch_act=="recommend_off"){
			act_url="<?php echo @ACT; ?>
/erp/SupSupplier/sup_supplier_modify_recommend_off/";
		}else if(batch_act=="del"){
			act_url="<?php echo @ACT; ?>
/erp/SupSupplier/sup_supplier_del/";
		}
	...
	$("body").on("click", ".single_operation", function() {
		...
		if(single_act=="linkman"){
			act_url="<?php echo @ACT; ?>
/erp/SupLinkman/cst_linkman_add/";
			layer.open({
				type: 2,
				title: '添加联系人',
				shadeClose: true,
...
/erp/SupLinkman/cst_linkman_add/supplier_id/'+supplier_id+'/' //iframe的url
			});			
			return false;	
...
/erp/SupSupplier/sup_supplier_add/',
			...
			layer.open({
				...
				area: ['90%', '90%'],
				content: '<?php echo @ACT; ?>
/erp/SupSupplier/sup_supplier_modify/supplier_id/'+supplier_id+'/',
				end: function () {
					turnPage(1);//页面加载时初始化分页
				}
			});			
			...
			layer.open({
				...
				area: ['800px', '500px'],
				content: '<?php echo @ACT; ?>
/erp/CstChance/cst_chance_add/supplier_id/'+supplier_id+'/' //iframe的url
			});			
			return false;
