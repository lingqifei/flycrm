<?php /* Smarty version 2.6.26, created on 2019-09-29 18:04:49
         compiled from erp/chart_purchase_show.html */ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5><i class="fa fa-home"></i> 采购汇总列表</h5>
                            ...
                            <div class="col-sm-9 m-b-xs text-right">
                                ...
                                <div class="form-group text-left pd-b-5 fly-form-select">
                                    <select name="date_type" class="form-control">
                                        ...
                                        <option value="2">采购日期</option>
                                        <option value="3">到货日期</option>
                                    </select>
                                </div>
                  ...
                  <button type="button" class="btn btn-primary ajaxSearchForm"><i class="fa fa-search"></i> 搜索</button>
                    ...
                    <table class="table table-hover sorttable 07fly-table" width="100%">
                        ...
                        <tr>
                            ...
                            <th width="150"><span>采购人员</span></th>
                            <th width="100" orderField="by_total_money" class="sort-filed"><span>采购总金额</span></th>
                            <th width="100" orderField="by_total_back_money" class="sort-filed"><span>已付总金额</span></th>
                            <th width="100" orderField="by_total_owe_money" class="sort-filed"><span>未付总金额</span></th>
...
<script id="tableListTpl" type="text/html">
    ...
    <tr>
        ...
        <td><%=Number(list[i]['total_pay_money'])%></td>
        <td><%=Number(list[i]['total_unpaid_money'])%></td>
...
/erp/ChartPurchase/chart_purchase_json/';
