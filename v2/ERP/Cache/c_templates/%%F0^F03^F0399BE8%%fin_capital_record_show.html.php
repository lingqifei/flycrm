<?php /* Smarty version 2.6.26, created on 2019-09-29 18:05:01
         compiled from erp/fin_capital_record_show.html */ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="col-sm-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5><i class="fa fa-home"></i> 资金注入抽取列表</h5>
          ...
          <table class="table table-hover sorttable 07fly-table" width="100%">
            <thead>
              <tr>
                ...
                <th width="80" orderField="by_recordid" class="sort-filed"><span>单号</span></th>
				  		<th width="150"><span>支出类型</span></th>
...
<% for(var i=0;i<list.length;i++) { %>
	<tr>
		...
		<td><%:=list[i]['type_arr']['name_html']%></td>
		<td><%=list[i]['money']%></td>
		<td>
...
/erp/FinCapitalRecord/fin_capital_record_json/';
...
/erp/FinCapitalRecord/fin_capital_record_del/";
...
/erp/FinCapitalRecord/fin_capital_record_add/',
				end: function () {
					turnPage(1);//页面加载时初始化分页
				}
			});			
